...
import type { EventAnchor, EventAnchorInterface } from "../EventAnchor";
...
type EventAnchorConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: EventAnchorConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class EventAnchor__factory extends ContractFactory {
  constructor(...args: EventAnchorConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override getDeployTransaction(
    _siteRegistry: AddressLike,
    overrides?: NonPayableOverrides & { from?: string }
  ): Promise<ContractDeployTransaction> {
    return super.getDeployTransaction(_siteRegistry, overrides || {});
  }
  override deploy(
    _siteRegistry: AddressLike,
    overrides?: NonPayableOverrides & { from?: string }
  ) {
    return super.deploy(_siteRegistry, overrides || {}) as Promise<
      EventAnchor & {
        deploymentTransaction(): ContractTransactionResponse;
      }
    >;
  }
  override connect(runner: ContractRunner | null): EventAnchor__factory {
    return super.connect(runner) as EventAnchor__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): EventAnchorInterface {
    return new Interface(_abi) as EventAnchorInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): EventAnchor {
    return new Contract(address, _abi, runner) as unknown as EventAnchor;
  }
}
